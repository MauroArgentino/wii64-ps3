...
#include "../ui/libgui/MessageBox.h"
#include "timers.h"
...
#include "../core/n64_memory/tlb.h"
#include "../core/n64_memory/pif.h"
#include "../core/n64_memory/flashram.h"
#include "../core/n64_memory/Saves.h"
...
//	gfx_set_fb(xfb[0], xfb[1]);
	...
	// For the menu, we want to use the full available resolution.
	gfx_set_window(0, 0, display_width, display_height);
