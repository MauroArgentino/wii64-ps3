...
// Los defines GX_... son específicos de Wii/GameCube, se eliminarán de aquí.
// Se asume que GraphicsRSX define sus propios equivalentes o que estos son manejados por la implementación de Graphics.
#endif //!__GX__
// #define GX_CLAMP	GCM_TEXTURE_CLAMP_TO_EDGE // Esto es una redefinición de GX_CLAMP para RSX, se moverá a GraphicsRSX.h
namespace menu {
