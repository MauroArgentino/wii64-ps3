   ...
   LogoTexture:
#ifdef HW_RVL
   .incbin	"../src/ui/resources/wii64.tx"
#else
   .incbin	"../src/ui/resources/cube64.tx"
#endif
   ...
   .balign 32
   LoadingTexture:
   .incbin	"../src/ui/resources/Loading.tx"
   ...
   .balign 32
   ControlEmptyTexture:
   .incbin	"../src/ui/resources/cntrlEmpty.tx"
   ...
   .incbin	"../src/ui/resources/cntrlGC.tx"
   ...
   .incbin	"../src/ui/resources/cntrlClassic.tx"
   ...
   .incbin	"../src/ui/resources/cntrlWNC.tx"
   ...
   .incbin	"../src/ui/resources/cntrlWM.tx"
